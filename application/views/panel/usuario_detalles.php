	...
	<div class="card shadow mb-4">
		<div class="card-body">
            <?php
                ...
                echo form_open(base_url('panel/usuario_detalles/actualizar'), $parametros);
            ?>
                ...
                <?php
                    echo form_submit('actualizar-usuario', 'Actualizar usuario', array('id'=>'boton-actualizar', 'class' => 'btn btn-primary btn-user'));
                ?>
