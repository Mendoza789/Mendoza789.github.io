...
class Acerca_del_sitio extends CI_Controller {
	...
	public function index()	{
		$this->crear_vista('portal/acerca_del_sitio', $this->cargar_datos());
	}//end index
	...
	public function cargar_datos(){
		...
		$datos['titulo_seccion'] = 'Acerca de este sitio';
	...
	public function crear_vista($nombre_vista=NULL, $datos=NULL){
		...
		$data['menu_portal'] = navegacion_portal($this->paginas->PAGINA_ACERCA_DEL_SITIO);
		$data['navegacion'] = $datos['navegacion'];

		$this->load->view('base/portal_base', $data);
	}//end crear_vista

}//end class Acerca_del_sitio
